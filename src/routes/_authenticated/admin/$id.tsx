...
function EditorPage() {
  ...
  const lbl = "block text-[11px] font-semibold uppercase tracking-[0.14em] text-[#1c1b18]/55 mb-1.5";
  const inp =
    "w-full rounded-xl border border-black/10 px-3.5 py-2.5 text-sm text-[#1c1b18] focus:outline-none focus:ring-2 focus:ring-[#c6a969]/45 bg-white";

  return (
    <div className="min-h-screen bg-[#f4f2ee]" style={{ fontFamily: "Inter, sans-serif" }}>
      <header className="border-b border-black/[0.06] bg-[#f4f2ee]/85 backdrop-blur-xl sticky top-0 z-10">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between gap-4">
          <div className="flex items-center gap-3 min-w-0">
            <Link
              to="/admin"
              className="inline-flex items-center gap-1.5 rounded-lg border border-black/10 bg-white px-3 py-1.5 text-sm font-medium text-[#1c1b18]/70 hover:text-[#1c1b18] cursor-pointer"
            >
              <ArrowLeft className="h-3.5 w-3.5" /> Posts
            </Link>
            <span className="truncate leading-none text-[#1c1b18]" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "26px" }}>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              disabled={busy}
              className="inline-flex items-center gap-2 rounded-xl border border-black/10 bg-white px-4 py-2.5 text-sm font-semibold text-[#1c1b18] transition-all hover:bg-[#faf9f6] disabled:opacity-50 cursor-pointer"
            >
              Save draft
            </button>
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-[#1c1b18] px-5 py-2.5 text-sm font-semibold text-white transition-all hover:bg-black hover:shadow-lg hover:shadow-black/10 disabled:opacity-50 cursor-pointer"
            >
